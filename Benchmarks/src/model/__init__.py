...
def get_model(model_cfg: DictConfig):
    ...
    elif model_handler == "ECO":
        print("Initializing ECO")
        model = ECO(model_cfg)
        tokenizer = model.tokenizer
    elif model_handler == "ULD":
        print("Initializing ULD")
        model = ULD(model_cfg)
        tokenizer = model.tokenizer
    elif model_handler == "WHP":
        print("Initializing WHP")
        model = WHP(model_cfg)
        tokenizer = model.tokenizer
    elif model_handler == "GUARD":
        print("Initializing GUARD")
        model = GUARD(model_cfg)
        tokenizer = model.tokenizer
